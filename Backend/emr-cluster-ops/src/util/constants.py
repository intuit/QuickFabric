...
TERMINATED_STATES = ['TERMINATED', 'TERMINATED_WITH_ERRORS']

# list-clusters
LIST_CLUSTERS_STATES = ['STARTING', 'BOOTSTRAPPING', 'RUNNING', 'WAITING', 'TERMINATING', 'TERMINATED', 'TERMINATED_WITH_ERRORS' ]
LIST_CLUSTERS_ACTIVE_STATES = ['STARTING', 'BOOTSTRAPPING', 'RUNNING', 'WAITING']
LIST_CLUSTERS_TERMINATED_STATES = ['TERMINATED']
LIST_CLUSTERS_FAILED_STATES = ['TERMINATED_WITH_ERRORS']
LIST_CLUSTERS_PROVISION_STATES = ['STARTING', 'BOOTSTRAPPING']
