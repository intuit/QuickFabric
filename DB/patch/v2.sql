DELIMITER $$
DROP PROCEDURE IF EXISTS patch_v2 $$

-- Create the stored procedure to perform patch
CREATE PROCEDURE patch_v2()
...
INSERT INTO workflow (workflow_name, workflow_step, lookup_table)VALUES ('patch-workflow2','mark_current_clusterrmination', now());
